...
def page2():
    ...
    if st.session_state.internal_results_available:
        ...
        st.image(st.session_state.image_path, caption=f"{st.session_state.ticker} Chart",
                 use_column_width=True)  # Example image
